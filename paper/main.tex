...
\access{Advance Access Publication Date: 13 5 2022}
\appnotes{Bioinformatics}
...
\title[short Title]{HICOD: Hierarchical Indexing for COmpacted Debruijn graphs}
\author[Sample \textit{et~al}.]{Nikhil Pateel\,$^{\text{\sfb 1,}*}$, Franklin Yang\,$^{\text{\sfb 1}}$}
\address{$^{\text{\sf 1}}$Department of Computer Science, University of
	Maryland, College Park, 20742, U.S.A }



\editor{Associate Editor: Rob Patro}
