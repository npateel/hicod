...
bcalm -in DNA_datasets/Homo_sapiens.GRCh38.dna.chromosome.13.fa.gz -kmer-size 31 -abundance-min 1 -nb-cores 64
...
bcalm -in DNA_datasets/Gadus_morhua.gadMor3.0.dna.toplevel.fa.gz -kmer-size 31 -abundance-min 1 -nb-cores 64
...
# bcalm -in DNA_datasets/bacterial.genome.fixed.fa -kmer-size 31 -abundance-min 1 -nb-cores 64
